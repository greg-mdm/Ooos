...
> Innovation **Dimension**", but `scripts/README-cid-data.md` and the
...
| Doc | Owns |
|---|---|
| `public/assets/video/LENS-CLIPS.md` | CID "Two Ways of Seeing" lens clips: adding, trimming, cache-busting |
| `src/app/components/population/README.md` | Pop Clock Mini internals, StatCan Web Data Service client |
| `public/pop-clock/README.md` | The standalone, dependency-free pop-clock export |
| `scripts/README-cid-data.md` | CID live-data pipeline, signals feed, OEA explorer |
| `ATTRIBUTIONS.md` | Asset and source credits |
| `.claude/skills/direct-to-main/SKILL.md` | The publish-to-main skill |
